        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div>
            <Link to="/" className="flex items-center gap-2.5 mb-4">
              <div className="w-11 h-11 rounded-full bg-gradient-to-br from-[#FF2A2A] to-[#00C2E6] flex items-center justify-center shadow-md">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm mb-5">
              ...
              <li className="flex gap-2.5 text-slate-400">
                ...
                <a href="tel:+919821811221" className="hover:text-[#00C2E6]">+91 98218 11221</a>
              </li>
              <li className="flex gap-2.5 text-slate-400">
