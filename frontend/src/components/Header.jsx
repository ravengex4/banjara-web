    ...
    <header className="sticky top-0 z-50 w-full">
        ...
        <div className="max-w-7xl mx-auto px-6 py-2 flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            ...
            {isAdmin && (
              <>
                <span className="opacity-40">|</span>
                <Link to="/admin" className="hover:text-[#00C2E6] transition-colors flex items-center gap-1">
      ...
      <div className={`bg-white transition-shadow ${scrolled ? 'shadow-md' : 'shadow-sm'}`}>
        <div className="max-w-7xl mx-auto px-6 py-3 flex items-center justify-between">
          ...
          <button className="lg:hidden p-2 text-[#003D52]" onClick={() => setOpen(!open)} aria-label="Toggle menu">
