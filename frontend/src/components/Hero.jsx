...
const Hero = () => {
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-[#1A3C5E] via-[#1F4870] to-[#1A3C5E]">
      {/* Decorative background */}
      <div className="absolute inset-0 opacity-10">
        <div className="absolute top-10 right-10 w-72 h-72 rounded-full bg-[#F5A623] blur-3xl" />
        <div className="absolute bottom-10 left-10 w-96 h-96 rounded-full bg-[#E86C2C] blur-3xl" />
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-white">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-[1.1] mb-5 tracking-tight">
              Your Visa, <span className="text-[#F5A623]">Simplified</span>.
              <br />
              For 150+ Countries.
            </h1>
            ...
            <div className="bg-white rounded-2xl p-2 shadow-2xl flex flex-col md:flex-row gap-2">
              <div className="flex-1 flex items-center gap-2 px-3">
                <MapPin className="w-5 h-5 text-[#E86C2C] flex-shrink-0" />
                <Select value={country} onValueChange={setCountry}>
                  <SelectTrigger className="border-0 shadow-none focus:ring-0 text-[#1A3C5E] font-medium h-12">
              ...
              <div className="flex-1 flex items-center gap-2 px-3">
                <Plane className="w-5 h-5 text-[#E86C2C] flex-shrink-0" />
              ...
              <Link to="/apply">
                <Button className="w-full md:w-auto h-12 px-7 bg-[#E86C2C] hover:bg-[#d05f24] text-white font-semibold gap-2">
          ...
          <div className="relative hidden lg:block">
            <div className="relative">
              <div className="absolute -top-4 -left-4 w-full h-full rounded-3xl bg-[#F5A623]/20" />
              <div className="absolute -bottom-4 -right-4 w-full h-full rounded-3xl bg-[#E86C2C]/20" />
              <img
              ...
              <div className="absolute -left-6 top-12 bg-white rounded-2xl shadow-xl p-4 flex items-center gap-3 max-w-[200px]">
                <div className="w-10 h-10 rounded-full bg-[#E86C2C]/10 flex items-center justify-center">
                  <Plane className="w-5 h-5 text-[#E86C2C]" />
                </div>
                <div>
                  <div className="text-xs text-slate-500">Visa Approved</div>
                  <div className="text-sm font-bold text-[#1A3C5E]">UAE · 4 Days</div>
                </div>
              </div>
              <div className="absolute -right-6 bottom-12 bg-white rounded-2xl shadow-xl p-4 flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm font-bold text-[#1A3C5E]">4.9 / 5.0</div>
                </div>
              </div>
            </div>
          </div>
