...
export const services = [
  { id: 1, title: 'Visa Application', description: 'End-to-end Tourist & Business visa processing for 150+ countries', icon: 'FileCheck' },
  { id: 2, title: 'E-Visa Services', description: 'Quick online e-visa applications with real-time status tracking', icon: 'Globe' },
  { id: 3, title: 'Document Attestation', description: 'MEA, state-level attestation and embassy legalization services', icon: 'Stamp' },
  { id: 4, title: 'Apostille Services', description: 'Apostille for personal & educational documents (Hague Convention)', icon: 'BookCheck' },
  { id: 5, title: 'FRRO Registration', description: 'Online FRRO registration for foreigners staying 180+ days in India', icon: 'UserCheck' },
  { id: 6, title: 'Travel Insurance', description: 'Visa-compliant travel insurance for individuals and groups', icon: 'ShieldCheck' },
  { id: 7, title: 'Indian Visa', description: 'India tourist, business, e-visa processing for all nationalities', icon: 'Plane' },
  { id: 8, title: 'B2B Agent Portal', description: 'Bulk visa submission, commission tracking and dedicated dashboard', icon: 'Briefcase' },
];

export const steps = [
  { id: 1, title: 'Select Visa', description: 'Choose your destination and visa type', icon: 'MapPin' },
  { id: 2, title: 'Customer Details', description: 'Fill in your personal information', icon: 'User' },
  { id: 3, title: 'Upload Documents', description: 'Submit required documents online', icon: 'Upload' },
  { id: 4, title: 'Visa Applied', description: 'Track your application in real-time', icon: 'CheckCircle' },
];
...
export const faqs = [
  { id: 1, question: 'How long does it take to process a visa?', answer: 'Visa processing time varies by country and visa type. e-Visas typically take 1-7 working days, while stamp visas may take 10-30 working days. We provide accurate timelines for each country on our service pages.' },
  { id: 2, question: 'What documents are required for a visa application?', answer: 'Required documents vary by destination and visa type. Common documents include a valid passport (6+ months validity), photographs, financial statements, travel itinerary, and accommodation proof. Our document checklist generator provides specific requirements.' },
  { id: 3, question: 'Do you offer visa services for foreigners in India?', answer: 'Yes, we provide comprehensive services for foreign nationals including FRRO registration, visa extensions, Indian e-Visa, business visa, and Port of Entry assistance. Our expert team guides you through every step.' },
  { id: 4, question: 'What is your visa success rate?', answer: 'We maintain a 98% visa approval success rate due to thorough documentation review, expert guidance, and personalized attention to each application. Our experienced consultants ensure your application meets all requirements.' },
  { id: 5, question: 'Do you provide B2B services for travel agents?', answer: 'Yes, we have a dedicated B2B portal for travel agents offering bulk visa submission, competitive pricing, commission tracking, and a dedicated account manager. Register on our B2B page to get started.' },
  { id: 6, question: 'Which payment methods do you accept?', answer: 'We accept all major payment methods including UPI, debit/credit cards, net banking, and digital wallets through our secure Razorpay integration. International clients can pay via wire transfer.' },
];
...
export const blogPosts = [
  { id: 1, title: 'How to Get Dubai Visa in 24 Hours from India', excerpt: 'Complete guide to fast-track UAE visa processing with required documents and tips.', category: 'UAE Visa', readTime: '5 min read', date: 'Jul 10, 2025', image: 'https://images.unsplash.com/photo-1512453979798-5ea266f8880c?w=800' },
  { id: 2, title: 'Schengen Visa Application: Complete Document Checklist', excerpt: 'Everything you need to know about applying for Schengen visa from India in 2025.', category: 'Europe Visa', readTime: '8 min read', date: 'Jul 5, 2025', image: 'https://images.unsplash.com/photo-1499856871958-5b9627545d1a?w=800' },
  { id: 3, title: 'USA B1/B2 Visa Interview Tips for Indian Applicants', excerpt: 'Expert advice on cracking your US visa interview on the first attempt.', category: 'USA Visa', readTime: '6 min read', date: 'Jun 28, 2025', image: 'https://images.unsplash.com/photo-1485738422979-f5c462d49f74?w=800' },
];
