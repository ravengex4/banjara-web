...
const About = () => (
  ...
  >
    <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
      <div>
        <div className="text-[#E86C2C] text-sm font-semibold uppercase tracking-wider mb-3">Our Story</div>
        <h2 className="text-3xl font-bold text-[#1A3C5E] mb-5">15+ Years of Visa Excellence</h2>
      ...
      <div className="relative">
        <div className="absolute -top-4 -left-4 w-full h-full rounded-3xl bg-[#F5A623]/15" />
        <img
    ...
    <div className="bg-gradient-to-br from-slate-50 to-white rounded-3xl p-10 mb-20 border border-slate-200">
      <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
        {stats.map((s, i) => (
          <div key={i}>
            <div className="text-4xl font-bold text-[#E86C2C] mb-1">{s.value}</div>
    ...
    <div className="mb-20">
      <div className="text-center mb-10">
        <div className="text-[#E86C2C] text-sm font-semibold uppercase tracking-wider mb-2">Our Values</div>
        <h2 className="text-3xl font-bold text-[#1A3C5E]">What Drives Us Forward</h2>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
        {values.map((v, i) => (
          <div key={i} className="bg-white border border-slate-200 rounded-2xl p-6 hover:shadow-lg hover:-translate-y-1 transition-all">
            ...
            <h3 className="font-bold text-[#1A3C5E] mb-2">{v.title}</h3>
    ...
    <div>
      <div className="text-center mb-10">
        <div className="text-[#E86C2C] text-sm font-semibold uppercase tracking-wider mb-2">Our Offices</div>
        <h2 className="text-3xl font-bold text-[#1A3C5E]">Visit Us Across India</h2>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
        {offices.map(o => (
          <div key={o.id} className="bg-white border border-slate-200 rounded-2xl p-6 hover:border-[#E86C2C]/40 hover:shadow-lg transition-all">
            <div className="text-[#E86C2C] text-xs font-semibold uppercase tracking-wider mb-2">Branch</div>
            <h3 className="font-bold text-[#1A3C5E] text-lg mb-3">{o.city}</h3>
