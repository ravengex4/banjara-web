      ...
      <div className="max-w-3xl mx-auto bg-white rounded-2xl border border-slate-200 p-8 shadow-sm">
        ...
        {step === 3 && (
          <div className="space-y-5">
            ...
            {['Passport (front & back)', 'Recent Photograph', 'Bank Statement (3 months)', 'Travel Itinerary'].map(doc => (
              <div key={doc} className="border-2 border-dashed border-slate-300 rounded-xl p-5 hover:border-[#FF2A2A] hover:bg-[#FF2A2A]/5 transition-all cursor-pointer">
                <div className="flex items-center gap-4">
                  ...
                  <Button size="sm" variant="outline" className="border-[#003D52] text-[#003D52]">Upload</Button>
                </div>
              </div>
            ))}
          </div>
        ...
        {step === 4 && (
          <div className="text-center py-10">
            ...
            <div className="text-2xl font-bold text-[#FF2A2A] tracking-wider mb-6">BTT-{Math.floor(Math.random() * 900000) + 100000}</div>
