  ...
  return (
    <SimplePage title="B2B Partner Portal" subtitle="Become a Banjara sub-agent and grow your travel agency with reliable visa services." breadcrumb="B2B Partner">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 mb-16">
        {benefits.map((b, i) => (
          <div key={i} className="bg-white border border-slate-200 rounded-2xl p-6 hover:border-[#E86C2C]/40 hover:shadow-lg transition-all">
            <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#E86C2C] to-[#F5A623] flex items-center justify-center mb-4 shadow-md">
              <b.icon className="w-6 h-6 text-white" />
            </div>
            <h3 className="font-bold text-[#1A3C5E] text-base mb-2">{b.title}</h3>
      ...
      <div className="grid lg:grid-cols-2 gap-10 items-start">
        <div>
          <div className="text-[#E86C2C] text-sm font-semibold uppercase tracking-wider mb-3">Why Partner With Us</div>
          <h2 className="text-3xl font-bold text-[#1A3C5E] mb-5">Grow Your Travel Business Without the Visa Hassle</h2>
          ...
          <ul className="space-y-3 mb-6">
            {[
              ...
              <li key={point} className="flex items-start gap-3 text-sm text-slate-700">
                <div className="w-5 h-5 rounded-full bg-[#E86C2C] flex items-center justify-center flex-shrink-0 mt-0.5">
          ...
          <Link to="/contact">
            <Button variant="outline" className="border-[#1A3C5E] text-[#1A3C5E] hover:bg-[#1A3C5E] hover:text-white gap-2">
        ...
        >
          <h3 className="text-2xl font-bold text-[#1A3C5E] mb-1">Register as Partner</h3>
          <p className="text-sm text-slate-600 mb-2">Tell us about your agency.</p>
          <div><Label className="text-[#1A3C5E] text-sm font-medium mb-2 block">Agency Name *</Label><Input className="h-11" /></div>
          <div className="grid sm:grid-cols-2 gap-4">
            <div><Label className="text-[#1A3C5E] text-sm font-medium mb-2 block">Contact Person *</Label><Input className="h-11" /></div>
            <div><Label className="text-[#1A3C5E] text-sm font-medium mb-2 block">Designation</Label><Input className="h-11" /></div>
          </div>
          <div className="grid sm:grid-cols-2 gap-4">
            <div><Label className="text-[#1A3C5E] text-sm font-medium mb-2 block">Email *</Label><Input type="email" className="h-11" /></div>
            <div><Label className="text-[#1A3C5E] text-sm font-medium mb-2 block">Phone *</Label><Input className="h-11" /></div>
          </div>
          <div><Label className="text-[#1A3C5E] text-sm font-medium mb-2 block">City</Label><Input className="h-11" /></div>
          <div><Label className="text-[#1A3C5E] text-sm font-medium mb-2 block">Tell us about your agency</Label><Textarea rows={3} /></div>
          <Button type="submit" className="w-full bg-[#E86C2C] hover:bg-[#d05f24] text-white h-12 gap-2 font-semibold">
